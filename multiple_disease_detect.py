...
with open('C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/Thyroid_model.sav', 'rb') as file:
    Thyroid_model = pickle.load(file)

with open("C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/Lung_cancer_model.sav", 'rb') as file:
    Lung_Cancer_model = pickle.load(file)

with open('C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/Breast_cancer_model.sav', 'rb') as file:
    Breast_Cancer_model = pickle.load(file)
    
with open('C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/Diabetes_model.sav', 'rb') as file:
    Diabetes_model = pickle.load(file)
    
with open("C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/Asthma_model.sav", 'rb') as file:
    Asthma_model = pickle.load(file)

with open("C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/PCOS_data.sav", 'rb') as file:
    PCOS_model = pickle.load(file)
    
with open("C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/Heart_stroke.sav", 'rb') as file:
    Heart_stroke_model = pickle.load(file)
        
with open("C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/Heart_Disease_model.sav", 'rb') as file:
    Heart_Disease_model = pickle.load(file)
    
with open('C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/parkinson_model.sav', 'rb') as file:
    parkinson_model = pickle.load(file)
    
with open("C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/Migraine_model.sav", 'rb') as file:
    Migraine_model = pickle.load(file)
    
with open("C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/Covid-19.sav",'rb') as file:
    Covid_19 = pickle.load(file)
    
with open("C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/Alzheimer_model.sav", 'rb') as file:
    Alzheimer_model = pickle.load(file)
    
with open("C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/depression_anxiety_data.sav",'rb') as file:
    depression_anxiety_data = pickle.load(file)
    
with open("C:/Users/HP/Desktop/Multiple_Disease_Detection/Models/kidney disease_model.sav", 'rb') as file:
